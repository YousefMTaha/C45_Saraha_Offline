...
export function OTPMailKey(email, mailType = MailType.confirmEmail) {
  return `OTP::user::${email}::${mailType}`;
}

export function OTPReqNoKey(email, mailType = MailType.confirmEmail) {
  return `OTP::user::${email}::${mailType}::No`;
}

export function OTPBlockedKey(email, mailType = MailType.confirmEmail) {
  return `OTP::user::${email}::${mailType}::Blocked`;
}
